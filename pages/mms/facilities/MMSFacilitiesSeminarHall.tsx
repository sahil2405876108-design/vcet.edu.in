...
export default function MMSFacilitiesSeminarHall() {
  ...
  const galleryItems = useMemo(() => {
    const remoteData = data?.seminarHall;
  ...
  return (
    <MMSLayout title="Seminar Hall">
      <FacilitiesSectionCard title="Seminar Hall" subtitle="A state-of-the-art venue for workshops, guest lectures, and conferences">
