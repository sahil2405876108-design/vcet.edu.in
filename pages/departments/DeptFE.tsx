      ...
      <header className="relative bg-gradient-to-r from-brand-navy to-slate-800 pt-28 pb-16 overflow-hidden shadow-lg border-b-4 border-brand-gold">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <h1 className="font-display font-bold text-white leading-[1.08] tracking-tight text-center">
            <span className="block text-4xl md:text-5xl lg:text-6xl">First Year Engineering</span>
          ...
          {activeId === 'faculty' && (
            <div className="space-y-10">
              <div className="reveal flex items-center justify-between flex-wrap gap-4 pb-5 border-b-2 border-brand-gold/30">
                <div>
                  <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-brand-navy/60 flex items-center gap-2 mb-1"><i className="ph-fill ph-chalkboard-teacher text-sm text-brand-navy/50" /> First Year Engineering</span>
                  <h2 className="text-2xl font-display font-bold text-brand-navy">Our Faculty</h2>
                </div>
                <div className="flex items-center divide-x divide-slate-200">
                  {[{ icon: 'ph-users-three', value: '15+', label: 'Members' }, { icon: 'ph-graduation-cap', value: '3+', label: 'PhD' }, { icon: 'ph-trophy', value: '30+', label: 'Yrs Exp.' }].map(stat => (
              ...
              <div className="reveal bg-brand-navylight rounded-2xl p-6 flex items-center gap-4 border border-brand-navy/10">
                ...
                <p className="text-sm text-brand-navy/70">Complete faculty profiles with photos are being updated. Please contact the department at <a href="mailto:fe@vcet.edu.in" className="underline font-semibold">fe@vcet.edu.in</a> for more information.</p>
              </div>
            </div>
          )}
