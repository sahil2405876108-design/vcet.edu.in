      ...
      <header className="relative bg-gradient-to-r from-brand-navy to-slate-800 pt-28 pb-16 overflow-hidden shadow-lg border-b-4 border-brand-gold">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <h1 className="font-display font-bold text-white leading-[1.08] tracking-tight text-center">
            <span className="block text-4xl md:text-5xl lg:text-6xl">Mechanical Engineering</span>
          </h1>
        </div>
      </header>
          ...
          {activeId === 'faculty' && (
            <div className="space-y-10">
              <div className="reveal flex items-center justify-between flex-wrap gap-4 pb-5 border-b-2 border-brand-gold/30">
                <div>
                  <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-brand-navy/60 flex items-center gap-2 mb-1"><i className="ph-fill ph-chalkboard-teacher text-sm text-brand-navy/50" /> Mechanical Engineering</span>
              ...
              <div className="reveal bg-brand-navylight rounded-2xl p-6 flex items-center gap-4 border border-brand-navy/10">
                ...
                <p className="text-sm text-brand-navy/70">Complete faculty profiles with photos are being updated. Please contact the department at <a href="mailto:mechanical@vcet.edu.in" className="underline font-semibold">mechanical@vcet.edu.in</a> for more information.</p>
              </div>
            </div>
          )}
